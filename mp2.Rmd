...
The Federal Election Commission (FEC) was formed in 1974 as an independent regulatory committee intended to uphold campaign finance laws. However, this agency has recently been struggling to do its job because of a lack of consensus between members, as well as a lack of funding. The analysis that we have done here is of data that all came from the FEC, from their archives which include information from 1980 to 2012. We are living in a time of great political unrest in which it is becoming increasingly important to be able to "follow the money." What we sought to do with this data in our analysis was to be able to better understand the relationship between campaign contribution and number of seats won, based on the candidate's party. 
