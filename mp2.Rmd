...
The Federal Election Commission (FEC) was formed in 1974 as an independent regulatory committee intended to uphold campaign finance laws. However, this agency has recently been struggling to do its job because of a lack of consensus between members, as well as a lack of funding. The analysis that we have done here is of data that all came from the FEC, from their archives which include information from 1980 to 2012. We are living in a time of great political unrest in which it is becoming increasingly important to be able to "follow the money." The question we sought to answer through our analysis was how campaign contributions affected the number of house seats won, separated by party and also by whether the candidate was an incumbent or a challenger. We believed that this research could have a real world implication in being able to better evaluate the effectiveness of campaign contributions. 

####*What we did to the data and why*
We joined house elections with contributions, and then seperated out the data to determine the number of incumbent versus challenger winners, as well as separating out the data by party. We decided to average contributions as well as represent total winners per state in this way so that our analysis could be shown rather simply in a few graphs rather than having a graph for every state. 
...
From these two graphs, we can see that the general trend is upheld from the graph of overall results. However, money spent is not directly related to total winners, but rather, there are simply more democratic winners in largely democratic states, and the same is true for its inverse. More money is spent on challengers in republican states than in democratic states. 
