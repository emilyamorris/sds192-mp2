...
The scatterplot shows that as the number of average contributions increases in a state the higher number of challengers (from both parties) win in that state. Converserly we can see that the more incumbment wins, the less money spent in the state. We can also see that the more wins corresponds with incumbendents. The more money spent the more challengers that win.
