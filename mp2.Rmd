...
winning_state_plotter <- function(name_arg){
  na.omit(name_arg)%>%
    ...
    scale_fill_manual(name= "Type of Winner", 
                     labels= c("REP_Incumbents"= "Republican Incumbents", "REP_Challengers"="Republican Challengers", "DEM_Incumbents"= "Democratic Incumbents", "DEM_Challengers"="Democratic Challengers", "NA"=" "),
...
winning_state_plotter(Democratic_states)+
  labs(title= "Total Number of House Seat Winners Per State by the Average Contributions Given in that State 
 for States with Majority Democratic Winners", subtitle= "According to the types of candidates that won")
