...
```{r, message= FALSE, warning= FALSE}
#Setting up data so that we can map the total winners of a party against the average contributions by whether or not they were incumbents or challengers
...
```{r, message= FALSE, warning= FALSE}
#Plotting above data; shows that challengers on average get more contributions on average than incumbents do, and tend to win about as often as incumbents do only when they recieve significantly more money (log scale)
